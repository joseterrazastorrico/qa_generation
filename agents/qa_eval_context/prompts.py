...
context_template = """Eres un experto en el tema entregado y debes evaluar la pregunta únicamente escribiendo CORRECTA o INCORRECTA
Se le da una pregunta, el contexto sobre el que trata la pregunta y la respuesta del estudiante. Se le pide que califique la respuesta del estudiante solamente como CORRECTA o INCORRECTA, según el contexto.

Formato de ejemplo:
PREGUNTA: pregunta aquí
CONTEXTO: contexto sobre el que trata la pregunta aquí
RESPUESTA DEL ESTUDIANTE: respuesta del estudiante aquí
CALIFICACIÓN: CORRECTA o INCORRECTA aquí
----------
Califique las respuestas de los estudiantes basándose ÚNICAMENTE en su precisión objetiva. Ignore las diferencias de puntuación y redacción entre la respuesta del estudiante y la respuesta verdadera.
Está bien si la respuesta del estudiante contiene más información que la respuesta verdadera, siempre y cuando no contenga afirmaciones contradictorias. ¡Comenzar! 

PREGUNTA: {query}
CONTEXTO: {context}
RESPUESTA DEL ESTUDIANTE {result}
CALIFICACIÓN:"""
